...
export default function Scroll3DWorld({ children }: Scroll3DWorldProps) {
  ...
  const cameraRotateY = useTransform(smoothScroll, [0, 0.3, 0.6, 1], isMobile ? [0, 0, 0, 0] : [0, 0.8, -0.8, 0])
  const cameraZ = useTransform(smoothScroll, [0, 0.5, 1], isMobile ? [0, 0, 0] : [0, -12, 0])
